...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------    
									-- UPDATE THE ESTABLISHMENT YEAR CATEGORY BY CATEGORIZING INTO DIFFERENT CATEGORIES --
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		
UPDATE bigsma
SET Est_Year_Category = 'Old'
WHERE Outlet_Establishment_Year <= 1995;					
                            
UPDATE bigsma
SET Est_Year_Category = 'Long'
WHERE Outlet_Establishment_Year >= 1996;                            
                     
UPDATE bigsma
SET Est_Year_Category = 'Recent'
WHERE Outlet_Establishment_Year >= 2006;  



  
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------    
									-- SALES PERFORMANCES BY OUTLET YEAR OF ESTABLISHMENT CATEGORY  --
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
 
SELECT Est_Year_Category, 
	SUM(Item_MRP) AS Sales_By_Item_Year_Est_Cat
FROM bigsma
	GROUP BY Est_Year_Category
    ORDER BY Sales_By_Item_Year_Est_Cat DESC;
